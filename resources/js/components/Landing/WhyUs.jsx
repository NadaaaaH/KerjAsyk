...
import { Search, Users, Lock, Target } from 'lucide-react';
            ...
            <div className="container">
                ...
                <div className="why-grid">
                    <div className="why-card rv">
                        <div className="wc-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Search size={32} color="var(--teal)" strokeWidth={1.5} /></div>
                        <div>
                    ...
                    <div className="why-card rv" style={{ transitionDelay: '.07s' }}>
                        <div className="wc-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Users size={32} color="var(--teal)" strokeWidth={1.5} /></div>
                        <div>
                    ...
                    <div className="why-card rv" style={{ transitionDelay: '.14s' }}>
                        <div className="wc-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Lock size={32} color="var(--teal)" strokeWidth={1.5} /></div>
                        <div>
                    ...
                    <div className="why-card rv" style={{ transitionDelay: '.21s' }}>
                        <div className="wc-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Target size={32} color="var(--teal)" strokeWidth={1.5} /></div>
                        <div>
